      ...
      .then(({ data: orderFull }) => {
        ...
        supabase.functions.invoke('order-notifications', {
          body: {
            ...
            shopSlug: orderFull.shops?.shop_slug || null,
            shopOwnerEmail: orderFull.shops?.owner_email || null,
            shopOwnerPhone: orderFull.shops?.whatsapp_number || null,
            deliveryAddress: orderFull.delivery_address || null,
            deliveryCity: orderFull.delivery_city || null,
            deliveryState: orderFull.delivery_state || null,
            paymentReference: orderFull.payment_reference || null,
