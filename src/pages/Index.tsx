...
const TESTIMONIALS = [
  {
    quote: "I used to spend 3 hours a day answering the same DMs. Now I paste my link and the store does the talking.",
    name: "Chidera O.",
    role: "Skincare merchant · Lagos",
    av: P.av1,
  },
  {
    quote: "My TikTok blew up and I had nowhere to send people. SteerSolo fixed that overnight.",
    name: "Amara S.",
    role: "Makeup artist · Abuja",
    av: P.av2,
  },
  {
    quote: "The SteerSolo Safe badge made buyers stop questioning if my products are real. Sales doubled in 6 weeks.",
    name: "Fatima B.",
  ...
  const phrases = [
    {
      ...
      h1: "Launch a professional store.\nShow prices clearly.\nKeep customers on WhatsApp.",
  ...
  <section className="py-24 bg-background relative overflow-hidden">
    ...
    <div className="mx-auto max-w-screen-xl px-4 relative z-10">
      <div className="flex flex-col md:flex-row items-end justify-between gap-10 mb-16 animate-fade-up">
        ...
        <Link
          to="/shops"
          className="inline-flex items-center gap-2 px-8 py-4 rounded-full bg-foreground text-background font-bold hover:scale-105 hover:shadow-2xl transition-all duration-300"
        >
          Explore Marketplace{" "}
...
const Index = () => {
  ...
  const DYNAMIC_STATS = [
    { n: "Fast", t: "Professional storefront launch", icon: Zap },
    { n: "Clear", t: "Catalogs with visible prices", icon: CreditCard },
    { n: "Direct", t: "Orders flow into WhatsApp", icon: MessageCircle },
    { n: `${liveVendorCount.toLocaleString()}`, t: "Verified merchants live on SteerSolo", icon: Users },
  ];
    ...
    <div className="font-sans overflow-x-hidden bg-background text-foreground">
              ...
              <div className="mt-8 p-5 rounded-[2rem] bg-card/40 border border-border/50 backdrop-blur-xl shadow-xl space-y-4 animate-fade-up f3">
                <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 border-b border-border/50 pb-4">
                  <div className="inline-flex items-center gap-3">
                    <div className="flex -space-x-2 shrink-0">
                      <img src={P.av1} alt="Merchant 1" className="w-8 h-8 rounded-full border-2 border-background object-cover" />
                      <img src={P.av2} alt="Merchant 2" className="w-8 h-8 rounded-full border-2 border-background object-cover" />
                      <img src={P.av3} alt="Merchant 3" className="w-8 h-8 rounded-full border-2 border-background object-cover" />
                    </div>
                    <div>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
                  {[
                    ...
                    <div key={t} className="flex items-center gap-2.5 px-3 py-2 rounded-xl bg-background/50 hover:bg-background transition-all duration-300 border border-border/50">
      ...
      <section className="py-24 bg-secondary/30">
        <div className="mx-auto max-w-screen-xl px-4">
          <div className="text-center mb-16">
            ...
            <h2 className="text-foreground font-extrabold text-4xl md:text-[56px] leading-[0.95] tracking-tight m-0">
            ...
            {PLATFORMS.map((platform, idx) => (
              ...
              >
                <div className="mb-6 flex items-center gap-4">
                  <div className="w-16 h-16 rounded-2xl flex items-center justify-center" style={{ background: platform.dotBg }}>
                    <PlatformLogo platform={platform} />
                  </div>
                  <div>
                    <p className="text-xs font-bold uppercase tracking-widest mb-1" style={{ color: platform.dot }}>
                ...
                <div className="mb-6 p-4 bg-red-50 dark:bg-red-950/10 border border-red-200 dark:border-red-900/30 rounded-xl">
                  <p className="text-sm text-red-800 dark:text-red-200 font-semibold mb-1">The Problem</p>
                ...
                <div className="p-4 bg-emerald-50 dark:bg-emerald-950/10 border border-emerald-200 dark:border-emerald-900/30 rounded-xl">
                  <p className="text-sm text-emerald-800 dark:text-emerald-200 font-semibold mb-1">The Solution</p>
      ...
      <section className="bg-background border-y border-border/40">
        <div className="flex flex-col lg:flex-row min-h-[420px]">
          ...
          <div className="flex-1 flex flex-col justify-center p-10 md:p-14 bg-secondary/30">
            ...
            {[
              ...
              <div key={i} className="flex items-start gap-5 mb-7">
            ...
            <div className="mt-2">
              <Link to="/auth/signup">
                <button className="inline-flex items-center gap-2.5 px-7 py-3.5 rounded-2xl font-bold text-sm text-primary-foreground bg-gradient-to-r from-primary to-accent shadow-lg hover:-translate-y-0.5 hover:shadow-xl active:translate-y-0 transition-all duration-300">
                  Be the exception{" "}
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="text-center mb-16 md:mb-20">
            ...
            <p className="text-muted-foreground max-w-2xl mx-auto text-base md:text-lg leading-relaxed">
              ...
              your store is before they spend a kobo.
            </p>
          </div>
          ...
          <div className="flex flex-col lg:flex-row items-start gap-16">
            <div className="flex-1 min-w-[320px]">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                {[
                  { icon: Shield, t: "100% Verified", d: "Every store has a SteerSolo Safe badge earned through real identity checks." },
                  { icon: MessageCircle, t: "WhatsApp Power", d: "Order on the web, track and chat on WhatsApp. The convenience you love." },
                  { icon: Truck, t: "Real-time Tracking", d: "Know exactly where your beauty products are from checkout to doorstep." },
                  { icon: Gift, t: "Curated Excellence", d: "Only the best Nigerian beauty and lifestyle merchants make the cut." },
                ].map((f, idx) => (
                  <div key={idx} className="flex items-start gap-3">
                    ...
                    <div>
                      <h4 className="font-bold text-foreground mb-1">{f.t}</h4>
