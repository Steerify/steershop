...
const painPoints = [
  ...
  },
  {
    ...
    description: "No catalog. No prices. Customers can't browse â€” they just leave.",
  },
  {
    icon: XCircle,
...
const Index = () => {
  return (
    <div className="min-h-screen bg-background">
      ...
      {/* SECTION 1: HERO â€” Outcome-first with Nigeria Map */}
          ...
          <div className="flex flex-col lg:flex-row items-center gap-8 lg:gap-12">
            ...
            <div className="flex-1 text-center lg:text-left space-y-8">
              ...
              <h2 className="text-2xl md:text-3xl lg:text-4xl font-bold text-foreground mt-4 animate-fade-up" style={{ animationDelay: '120ms' }}>
                Give buyers proof, prices and confidence â€”
                {" "}
                <TypewriterEffect
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-muted-foreground max-w-2xl mx-auto text-balance">
              You're not losing sales because demand is low â€” you're losing them because your order process is messy.
            </p>
          </div>
      ...
      {/* SECTION 3: WHAT IS STEERSOLO + WHY â€” Show the solution */}
      ...
      {/* SECTION 3B: WHAT IS STEERSOLO + WHY â€” Show the solution */}
      <WhySteerSolo />

      {/* SECTION 4: HOW IT WORKS â€” Make it feel easy */}
      <HowItWorks />

      {/* SECTION 5: SOCIAL PROOF STATS â€” Back it up with numbers */}
      <SocialProofStats />

      {/* SECTION 6: REVIEWS â€” Real people, real trust */}
      <HomepageReviews />

      {/* SECTION 7: FEATURED SHOPS â€” Show live proof */}
      <FeaturedShopsBanner />

      {/* SECTION 8: PRICING â€” Now they're ready to buy */}
      <DynamicPricing />

      {/* SECTION 9: SHOPPER DISCOVERY â€” Secondary value prop */}
      <ShopperDiscovery />

      {/* SECTION 10: FINAL CTA â€” Close with guarantee */}
