...
const SmallBusinessTools = () => (
  <SEOPageTemplate
    ...
    faqs={[
      ...
      { question: "Is SteerSolo free for small businesses?", answer: "Yes! SteerSolo offers a free forever Starter plan with up to 5 products. Paid plans start at ₦2,500/month — cheaper than any other business tool." },
