        ...
        <div className="container mx-auto px-4">
          <Card className="max-w-4xl mx-auto border-primary/10">
            <CardContent className="p-6 md:p-10 prose prose-slate dark:prose-invert max-w-none">
              ...
              <h3 className="font-heading text-xl font-semibold mb-3">2.4 Device and Technical Data</h3>
              <p className="text-muted-foreground mb-6">
              ...
              <ul className="list-disc pl-6 text-muted-foreground mb-6 space-y-2">
                ...
                <li><strong>Communication:</strong> To send service-related notifications, updates, and marketing communications (with consent)</li>
              ...
              <h2 className="font-heading text-2xl font-bold text-primary mb-4">6. Data Security Measures</h2>
              ...
              <h2 className="font-heading text-2xl font-bold text-primary mb-4">7. Cookies and Tracking Technologies</h2>
              ...
              <h3 className="font-heading text-xl font-semibold mb-3">8.1 Paystack</h3>
              <p className="text-muted-foreground mb-4">
                Payment processing is handled by Paystack. When you make a payment, your financial information is transmitted directly to Paystack using their secure payment infrastructure. Please review Paystack's Privacy Policy for information on how they handle your data.
              </p>

              <h3 className="font-heading text-xl font-semibold mb-3">8.2 WhatsApp</h3>
              <p className="text-muted-foreground mb-6">
              ...
              <h2 className="font-heading text-2xl font-bold text-primary mb-4">9. Your Rights Under NDPR</h2>
              ...
              <h2 className="font-heading text-2xl font-bold text-primary mb-4">10. Data Retention</h2>
              <p className="text-muted-foreground mb-6">
              ...
              <h2 className="font-heading text-2xl font-bold text-primary mb-4">11. Children's Privacy</h2>
              <p className="text-muted-foreground mb-6">
              ...
              <h2 className="font-heading text-2xl font-bold text-primary mb-4">12. International Data Transfers</h2>
              <p className="text-muted-foreground mb-6">
                Your data may be stored and processed in countries outside Nigeria where our service providers operate. When we transfer data internationally, we ensure appropriate safeguards are in place to protect your information in accordance with NDPR requirements.
              </p>

              <Separator className="my-8" />

              <h2 className="font-heading text-2xl font-bold text-primary mb-4">13. Changes to This Privacy Policy</h2>
              <p className="text-muted-foreground mb-6">
              ...
              <div className="bg-muted/50 p-4 rounded-lg mb-6">
                ...
                <p className="text-foreground">SteerSolo Limited</p>
                <p className="text-muted-foreground">Lagos, Nigeria</p>
                <p className="text-muted-foreground">Email: privacy@steersolo.com</p>
              ...
              <div className="bg-primary/5 border border-primary/20 p-6 rounded-lg">
                ...
                <p className="text-muted-foreground text-sm">
                  SteerSolo Limited is committed to complying with the Nigeria Data Protection Regulation (NDPR) 2019 and the Nigeria Data Protection Act (NDPA) 2023. We have implemented appropriate technical and organizational measures to ensure the protection of your personal data and respect for your privacy rights.
                </p>
              </div>
