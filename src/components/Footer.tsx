  ...
  return (
    <footer className="relative bg-brand-forest-deep text-[hsl(35,30%,96%)] overflow-hidden">
      ...
      <div className="relative z-10 container mx-auto px-4 sm:px-6 py-8 sm:py-12">
        <div className="grid grid-cols-2 sm:grid-cols-2 md:grid-cols-4 gap-6 sm:gap-8">
          ...
          <div className="col-span-2 sm:col-span-2 md:col-span-1">
            ...
            <p className="text-white/80 text-xs sm:text-sm leading-relaxed">
              Empowering Nigerian solo entrepreneurs to build, grow, and thrive
            ...
            <div className="flex items-center gap-3 sm:gap-4 mt-4 sm:mt-6">
              ...
              <a
                href="https://www.threads.net/@steerifygroup"
                target="_blank"
                rel="noopener noreferrer"
                className="w-9 h-9 sm:w-10 sm:h-10 rounded-full bg-white/10 flex items-center justify-center hover:bg-accent/20 hover:text-accent transition-colors"
                aria-label="Threads"
        ...
        {/* Notice about Terms & Privacy */}
        <div className="mt-6 mb-2">
          <NoticeBadge variant="legal" className="w-full">
            By using SteerSolo you agree to our{" "}
        ...
        {/* Bottom Bar */}
        <div className="mt-4 sm:mt-12 pt-6 sm:pt-8 border-t border-white/10">
          <div className="flex flex-col sm:flex-row items-center justify-between gap-3 sm:gap-4">
            ...
            <div className="flex items-center gap-1 text-xs sm:text-sm text-white/70">
              Made with{" "}
              <Heart className="w-3 h-3 sm:w-4 sm:h-4 text-destructive fill-destructive animate-pulse-soft" />{" "}
              in Nigeria 🇳🇬
            </div>
          </div>
        </div>
