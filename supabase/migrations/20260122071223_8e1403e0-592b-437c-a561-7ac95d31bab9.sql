-- Fix profiles RLS and user_roles update access for role selection
...
-- 3. Allow users to UPDATE their role in user_roles table
...
-- 4. Allow users to INSERT their role in user_roles table  
